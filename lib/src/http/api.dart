...
// Отправить данные о количестве актива с изображениями
  ...
  Future<NotificationSettings> getNotificationSettings() async {
    ...
    final response = await http.get(
      Uri.parse('$baseUrl/v1/company/notifications/mobile/settings'),
      headers: {
        'Authorization': 'Bearer $jwtToken',
      },
    );
  ...
  Future<NotificationListResponse> getNotifications({
    ...
    final uri = Uri.parse('$baseUrl/v1/company/notifications/mobile')
  ...
  Future<int> markNotificationRead(String notificationUuid) async {
    ...
    final response = await http.post(
      Uri.parse(
          '$baseUrl/v1/company/notifications/mobile/$notificationUuid/read'),
      headers: {
        'Authorization': 'Bearer $jwtToken',
      },
    );
  ...
  Future<StreamedResponseHandle> openNotificationStream() async {
    ...
    final request = http.Request(
        'GET', Uri.parse('$baseUrl/v1/company/notifications/mobile/stream'));
    request.headers['Authorization'] = 'Bearer $jwtToken';
